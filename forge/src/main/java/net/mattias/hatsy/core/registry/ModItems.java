...
public class ModItems {
    ...
    public static final RegistryObject<Item> ASH_KETCHUM_HAT = registerItem("ash_ketchum_hat", () -> new AshKetchumHatItem(ArmorMaterials.LEATHER, ArmorItem.Type.HELMET, new Item.Properties()));
    ...
    public static void addToHatsTab(CreativeModeTab.Output output) {
        ...
        output.accept(ASH_KETCHUM_HAT.get());
